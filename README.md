...
The files for the texture pack are not hosted here on GitHub, rather this README and other necessary files stored here for reference. Refer to the mirror links to download them.
